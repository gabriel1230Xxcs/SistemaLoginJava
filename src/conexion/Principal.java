...
public class Principal extends JFrame {
    ...
    private void editar() {
        ...
        if(fila >= 0){
            ...
            String nombre = JOptionPane.showInputDialog("Nombre:", modelo.getValueAt(fila,2));
            String apellido = JOptionPane.showInputDialog("Apellido:", modelo.getValueAt(fila,3));
            String telefono = JOptionPane.showInputDialog("Telefono:", modelo.getValueAt(fila,4));
            String correo = JOptionPane.showInputDialog("Correo:", modelo.getValueAt(fila,5));
